...
public class DepartmentTests
{
    ...
    public void Trying_to_set_empty_name_should_catch_Exception()
    {
        ...
        try
        {
            Department d = new Department(null, new Dictionary<int, Room>());
    ...
    public void Trying_to_create_Department_with_specific_name_and_check_if_it_assigned_correctly()
    {
        ...
        String name = "Test1";
        Department d = new Department(name, new Dictionary<int, Room>(){{1, new Room()}});
    ...
    public void Trying_to_create_Department()
    {
        ...
        Department d = new Department("Test1", new Dictionary<int, Room>(){{1, new Room()}});
        Assert.Pass();
        Department.removeDepartment(d);
    }
    ...
    public void Trying_to_create_List_of_Departments_and_SetAppointments()
    {
        ...
        List<Department> ld = new List<Department>{new ( "Test1", new Dictionary<int, Room>(){{1, new Room()}}), new ( "Test2", new Dictionary<int, Room>(){{1, new Room()}}), new ( "Test3", new Dictionary<int, Room>(){{1, new Room()}})};
    ...
    public void Trying_to_create_same_Department_throws_InvalidOperationException()
    {
        ...
        Department b = new Department("Test1", new Dictionary<int, Room>(){{1, new Room()}});
        try
        {
            Department b2 = new Department("Test1", new Dictionary<int, Room>(){{1, new Room()}});
    ...
    {
        Department department = new Department("Test1", new Dictionary<int, Room>(){{1, new Room()}});
    ...
    {
        Department department = new Department("Test", new Dictionary<int, Room>(){{1, new Room()}});
        List<Room> rooms = new List<Room>{new (Room.RoomType.Double, Room.RoomAvailability.Available), new (Room.RoomType.Double, Room.RoomAvailability.Available), new (Room.RoomType.Double, Room.RoomAvailability.Available)};
    ...
    {
        Department department = new Department("Test", new Dictionary<int, Room>(){{1, new Room()}});
        Nurse nurse = new Nurse(1,"Test2", new List<Shift>(){new Shift()});
    ...
    {
        foreach (Nurse n in Nurse.GetNurses())
        {
            Nurse.removeNurse(n);
        }
        Department department = new Department("Test", new Dictionary<int, Room>(){{1, new Room()}});
        List<Nurse> nurses = new List<Nurse>{new (4,"Test3", new List<Shift>(){new Shift()}),
            new (5,"Test4", new List<Shift>(){new Shift()}),
            new (6,"Test5", new List<Shift>(){new Shift()})};
    ...
    public void Trying_to_add_Nurse_to_Department_and_then_change_it()
    {
        ...
        Department department = new Department("Test", new Dictionary<int, Room>(){{1, new Room()}});
        Department department2 = new Department("Test2", new Dictionary<int, Room>(){{1, new Room()}});
        Nurse nurse = new Nurse(1,"Test2", new List<Shift>(){new Shift()});
        department.addNurseToDepartment(nurse);
    ...
    {
        Department department = new Department("Test", new Dictionary<int, Room>(){{1, new Room()}});
        Physician doctor = new Physician(1,"Test1","Test1", new List<Shift>(){new Shift()});
    ...
    {
        Department department = new Department("Test", new Dictionary<int, Room>(){{1, new Room()}});
        List<Physician> doctors = new List<Physician>{new (4,"Test1","Test1", new List<Shift>(){new Shift()}),
            new (5,"Test1","Test2", new List<Shift>(){new Shift()}),
            new (6,"Test1","Test3", new List<Shift>(){new Shift()})};
    ...
    public void Trying_to_add_Department_to_Doctor_and_then_remove_it()
    {
        ...
        foreach (var e in department.GetDoctors())
        {
            if (e == doctor && doctor.Department != null && doctor.Department.Equals(department))
            {
                department.removeDoctorFromDepartment(doctor);
